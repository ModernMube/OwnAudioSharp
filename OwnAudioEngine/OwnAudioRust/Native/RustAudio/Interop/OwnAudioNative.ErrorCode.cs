...
/// <summary>
/// Mirrors the <c>OwnAudioErrorCode</c> enum from <c>ownaudio_ffi.h</c>.
/// Values must match exactly — generated by cbindgen from Rust source.
/// Mapping from these raw codes to C# exceptions is the responsibility of
/// the safe wrapper layer (step 5), not this layer.
/// </summary>
