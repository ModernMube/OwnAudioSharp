...
namespace OwnaudioNET.Features.Vocalremover
{
    ...
    public class SimpleAudioSeparationService : IDisposable
    {
        ...
        private float[,] LoadAndPrepareAudio(string filePath)
        {
            ...
            AudioDecoderResult result = decoder.DecodeAllFrames(TimeSpan.FromSeconds(0));
            var samples = System.Runtime.InteropServices.MemoryMarshal.Cast<byte, float>(result.Frame.Data.AsSpan());
