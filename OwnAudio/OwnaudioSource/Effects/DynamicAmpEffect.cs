...
namespace OwnaudioNET.Effects
{
    ...
    public sealed class DynamicAmpEffect : IEffectProcessor
    {
        ...
        /// <summary>
        /// Gets or sets the wet/dry mix ratio (0.0 = dry, 1.0 = wet)
        /// </summary>
        ...
        /// </summary>
        /// <param name="buffer">Array of audio samples to process in-place</param>
        ...
        public void Process(Span<float> buffer, int frameCount)
        {
            ...
            var samples = buffer.Slice(0, sampleCount);
...
#nullable restore
        ...
        {
            return $"{_name} (ID: {_id}, Enabled: {_enabled}, Target: {targetRmsLevelDb:F1}dB, Gain: {currentGain:F2})";
        }
    }
}
