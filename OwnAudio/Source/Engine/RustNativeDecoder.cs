...
/// <summary>
/// Puts the Rust StreamingAudioDecoder behind IAudioDecoder. The Symphonia backend (WAV, MP3, FLAC,
/// OGG, AAC/M4A, ALAC/M4A, AIFF) is the only decoder there is - nothing else picks up what it can't open.
/// </summary>
