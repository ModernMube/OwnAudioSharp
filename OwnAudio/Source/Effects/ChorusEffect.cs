...
namespace OwnaudioNET.Effects
{
    ...
    public sealed class ChorusEffect : IEffectProcessor
    {
        ...
        /// </summary>
        public ChorusEffect() : this(1.0f, 0.5f, 0.5f, 3, 44100)
        {
        }
        ...
        public ChorusEffect(ChorusPreset preset, int sampleRate = 44100)
        {
            _id = Guid.NewGuid();
            _name = "Chorus";
            _enabled = true;
        ...
        /// <param name="sampleRate">Sample rate</param>
        public ChorusEffect(float rate, float depth, float mix, int voices, int sampleRate)
        {
            _id = Guid.NewGuid();
            _name = "Chorus";
            _enabled = true;
        ...
        public void Process(Span<float> buffer, int frameCount)
        {
            ...
            for (int i = 0; i < sampleCount; i++)
            {
                ...
                buffer[i] = (input * (1.0f - Mix)) + (chorusOutput * Mix);
        ...
        /// <summary>
        /// Disposes the chorus effect and releases resources.
        /// </summary>
        public void Dispose()
        {
            if (_disposed)
        ...
        {
            return $"Chorus: Rate={_rate:F2}Hz, Depth={_depth:F2}, Mix={_mix:F2}, Voices={_voices}, Enabled={_enabled}";
        }
    }
}
