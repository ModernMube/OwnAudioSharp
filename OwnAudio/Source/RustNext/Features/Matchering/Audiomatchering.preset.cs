...
namespace OwnaudioNET.RustNext.Features.Matchering
{
    partial class AudioAnalyzer
    {
            ...
            PlaybackSystem system, bool eqOnlyMode = false)
        {
            ...
            OwnaudioNET.RustNext.Recording.WaveFile.Create(processedBaseSample, processedData.ToArray(), sampleRate, channels, 24);
        ...
        private bool LoadBaseSample(string path)
        {
            ...
            try
            {
                ...
                OwnaudioNET.RustNext.Recording.WaveFile.Create(path, memoryStream.ToArray(), 48000, 2, 24);
