...
using OwnaudioNET.RustNext.Features.OwnChordDetect.Detectors;
using OwnaudioNET.Exceptions;
using Ownaudio.Decoders;
using Ownaudio.Core;
using SoundTouch;

namespace OwnaudioNET.RustNext.Features.OwnChordDetect;
...
#nullable restore
        ...
        List<OwnaudioNET.RustNext.Features.Extensions.Note> rawNotes = converter.Convert(convertOptions);
