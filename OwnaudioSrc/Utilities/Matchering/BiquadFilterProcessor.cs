...
{
    /// <summary>
    /// Enumeration of supported biquad filter types
    /// </summary>
    public enum BiquadType
    {
        ...
        /// <summary>
        /// Band-pass filter that passes frequencies within a specific range
        /// </summary>
        Bandpass,
        ...
        /// <summary>
        /// Peaking filter that boosts or cuts frequencies around a center frequency
        /// </summary>
        Peaking,

        /// <summary>
        /// Low shelf filter that affects frequencies below a cutoff frequency
        /// </summary>
        LowShelf,

        /// <summary>
        /// High shelf filter that affects frequencies above a cutoff frequency
        /// </summary>
        HighShelf
    }

    /// <summary>
    /// Biquad filter implementation for various filter types with stability checking
    /// </summary>
    public class BiquadFilter
    {
        ...
        /// <summary>
        /// Initializes a new instance of the BiquadFilter class
        /// </summary>
        /// <param name="frequency">Center or cutoff frequency in Hz</param>
        /// <param name="gainDb">Gain in decibels for peaking and shelf filters</param>
        /// <param name="q">Quality factor (bandwidth control)</param>
        /// <param name="sampleRate">Audio sample rate in Hz</param>
        /// <param name="type">Type of biquad filter to create</param>
        public BiquadFilter(float frequency, float gainDb, float q, int sampleRate, BiquadType type)
        {
